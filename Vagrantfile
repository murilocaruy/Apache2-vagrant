...
Vagrant.configure("2") do |config|
  ...
  git clone https://github.com/murilocaruy/introducao-html-css.git /var/www/introducao-html-css
  git clone https://github.com/murilocaruy/Apache2-vagrant.git /etc/apache2/sites-enable
